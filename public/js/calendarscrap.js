...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let allevents = [
          ...
          { title:'Distribute Blackberry Mint',start:'2025-08-12',end:'2025-08-23',color:'purple',textColor:'green'},
          { title:'Distribute Ginger',start:'2025-08-02',end:'2025-08-16',color:'gold',textColor:'black'},
