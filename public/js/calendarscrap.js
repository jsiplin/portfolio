...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let allevents = [
          ...
          {
            title: 'Brewing Pomegranate Ginger',
            start: '2024-12-26',
            end: '2025-01-04',
            color: 'violet',
            textColor: 'white'
          ...
          {
            title: 'Distribute Pomegranate Ginger',
            start: '2025-01-05',
            end: '2025-01-10',
            color: 'greenyellow',
            textColor: 'black'
